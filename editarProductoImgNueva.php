<?php
    ...
    if (move_uploaded_file($_FILES['image']['tmp_name'], $fichero_subido)) {
        ...
        $query = "UPDATE productos SET nombreProducto=\"$nombreProducto\",descripcion=\"$descripcion\",precio=$precio,existencia=$unidades,linkIMG=\"$fichero_subidobd\" WHERE idProducto = $idProducto";
...
<html>
<head>
<meta http-equiv="refresh" content="1;url=https://abastecedorafcc.000webhostapp.com/editarProductos.html">
</head>
<body>
